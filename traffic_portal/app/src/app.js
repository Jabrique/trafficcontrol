...
var trafficPortal = angular.module('trafficPortal', [
        ...
        require('./modules/private/apiIPRules').name,
        ...
        require('./modules/private/user/apiTokens').name,
        ...
        require('./common/modules/dialog/evaluateIPRule').name,
        require('./common/modules/dialog/selectEndpoint').name,
        ...
        require('./common/modules/form/apiToken').name,
        require('./common/modules/form/apiToken/new').name,
        require('./common/modules/form/apiIPRule').name,
        require('./common/modules/form/apiIPRule/new').name,
        require('./common/modules/form/apiIPRule/edit').name,
        ...
        require('./common/modules/table/apiTokens').name,
        require('./common/modules/table/apiIPRules').name,
